...
logic the the axios instance of the lambda component. The main use
case is to define 'global' error-handling. This component displays
a modal containing the error message.

It's function is similiar to withErrorBoundary, except withErrorBoundary
...
asynchronousrequests via an axios instance is applicable.
*/
